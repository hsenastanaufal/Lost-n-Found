    ...
    if (phone.isNotEmpty) {
      ...
      try {
        if (await canLaunchUrl(waUrl)) {
          ...
          final Uri waSchemeUrl = Uri.parse('whatsapp://send?phone=$formattedPhone&text=${Uri.encodeComponent('Halo, saya menghubungi terkait laporan ${item.name} di aplikasi Lost & Found TelU.')}');
